...
execute if score #slot ckenja.reversible matches ..35 run function ckenja.reversible:turn/main
...
execute if score #slot ckenja.reversible matches 18.. if score #slot.row ckenja.reversible matches 2.. run function ckenja.reversible:turn/main
data modify storage ckenja.reversible: turn.callback set value "down-right"
execute if score #slot ckenja.reversible matches ..35 if score #slot.row ckenja.reversible matches ..6 run function ckenja.reversible:turn/main

#%= #8

data modify storage ckenja.reversible: turn.callback set value "up-right"
execute if score #slot ckenja.reversible matches 18.. if score #slot.row ckenja.reversible matches ..6 run function ckenja.reversible:turn/main
data modify storage ckenja.reversible: turn.callback set value "down-left"
execute if score #slot ckenja.reversible matches ..35 if score #slot.row ckenja.reversible matches 2.. run function ckenja.reversible:turn/main
