...
data modify block ~ ~ ~ Items[{Slot:9b}].id set from storage ckenja.reversible: reflect.Items[{Slot:9b}].id
...
data modify block ~-1 ~ ~ Items[{Slot:0b}].id set from storage ckenja.reversible: reflect.Items[{Slot:27b}].id
data modify block ~-1 ~ ~ Items[{Slot:1b}].id set from storage ckenja.reversible: reflect.Items[{Slot:28b}].id
data modify block ~-1 ~ ~ Items[{Slot:2b}].id set from storage ckenja.reversible: reflect.Items[{Slot:29b}].id
data modify block ~-1 ~ ~ Items[{Slot:3b}].id set from storage ckenja.reversible: reflect.Items[{Slot:30b}].id
data modify block ~-1 ~ ~ Items[{Slot:4b}].id set from storage ckenja.reversible: reflect.Items[{Slot:31b}].id
data modify block ~-1 ~ ~ Items[{Slot:5b}].id set from storage ckenja.reversible: reflect.Items[{Slot:32b}].id
data modify block ~-1 ~ ~ Items[{Slot:6b}].id set from storage ckenja.reversible: reflect.Items[{Slot:33b}].id
data modify block ~-1 ~ ~ Items[{Slot:7b}].id set from storage ckenja.reversible: reflect.Items[{Slot:34b}].id
data modify block ~-1 ~ ~ Items[{Slot:8b}].id set from storage ckenja.reversible: reflect.Items[{Slot:35b}].id
data modify block ~-1 ~ ~ Items[{Slot:9b}].id set from storage ckenja.reversible: reflect.Items[{Slot:36b}].id
data modify block ~-1 ~ ~ Items[{Slot:10b}].id set from storage ckenja.reversible: reflect.Items[{Slot:37b}].id
data modify block ~-1 ~ ~ Items[{Slot:11b}].id set from storage ckenja.reversible: reflect.Items[{Slot:38b}].id
data modify block ~-1 ~ ~ Items[{Slot:12b}].id set from storage ckenja.reversible: reflect.Items[{Slot:39b}].id
data modify block ~-1 ~ ~ Items[{Slot:13b}].id set from storage ckenja.reversible: reflect.Items[{Slot:40b}].id
data modify block ~-1 ~ ~ Items[{Slot:14b}].id set from storage ckenja.reversible: reflect.Items[{Slot:41b}].id
data modify block ~-1 ~ ~ Items[{Slot:15b}].id set from storage ckenja.reversible: reflect.Items[{Slot:42b}].id
data modify block ~-1 ~ ~ Items[{Slot:16b}].id set from storage ckenja.reversible: reflect.Items[{Slot:43b}].id
data modify block ~-1 ~ ~ Items[{Slot:17b}].id set from storage ckenja.reversible: reflect.Items[{Slot:44b}].id
data modify block ~-1 ~ ~ Items[{Slot:18b}].id set from storage ckenja.reversible: reflect.Items[{Slot:45b}].id
data modify block ~-1 ~ ~ Items[{Slot:19b}].id set from storage ckenja.reversible: reflect.Items[{Slot:46b}].id
data modify block ~-1 ~ ~ Items[{Slot:20b}].id set from storage ckenja.reversible: reflect.Items[{Slot:47b}].id
data modify block ~-1 ~ ~ Items[{Slot:21b}].id set from storage ckenja.reversible: reflect.Items[{Slot:48b}].id
data modify block ~-1 ~ ~ Items[{Slot:22b}].id set from storage ckenja.reversible: reflect.Items[{Slot:49b}].id
data modify block ~-1 ~ ~ Items[{Slot:23b}].id set from storage ckenja.reversible: reflect.Items[{Slot:50b}].id
data modify block ~-1 ~ ~ Items[{Slot:24b}].id set from storage ckenja.reversible: reflect.Items[{Slot:51b}].id
data modify block ~-1 ~ ~ Items[{Slot:25b}].id set from storage ckenja.reversible: reflect.Items[{Slot:52b}].id
data modify block ~-1 ~ ~ Items[{Slot:26b}].id set from storage ckenja.reversible: reflect.Items[{Slot:53b}].id
...
#tellraw @a {"storage":"ckenja.reversible:","nbt":"reflect.Items"}
